...
class tx_history_archiver {
  public:
      ...
      /// \param db_param parameter to be used for DB initialization (for LevelDB it is directory name)
      tx_history_archiver(uint32_t sentinel_id,
                std::shared_ptr<logging::log> logger,
                const std::string& db_param = "../tha_db");
