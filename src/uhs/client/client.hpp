...
namespace cbdc {
    ...
    class client {
      public:
        ...
        create_transaction(uint32_t amount,
                           cbdc::pubkey_t payee,
        ...
        std::optional<pubkey_t> get_tnswap_session_key(cbdc::skey_hash_t s_hash); 
      ...
      private:
        ...
        transaction::swap_wallet m_wallet{};

        std::shared_ptr<cbdc::client_transaction_handler> m_client_transaction_handler;
